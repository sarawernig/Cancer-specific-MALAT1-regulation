...
#Run as: bash ./01_ATAC-seq_24h_analysis.sh
...
$project_folder/scripts/02_ATAC-seq_24h_diffBind_script_MALAT1.R
...
plotPCA -in results/PCA_analysis/multiBamSummary_CTRLvsMALAT1.npz \
 -o results/PCA_analysis/PCA_readCounts_CTRLvsMALAT1.png -T "PCA of 24h-post MALAT1 KD ATAC-seq samples" --labels Ctrl_rep1 Ctrl_rep2 Ctrl_rep3 MALAT1_rep1 MALAT1_rep2 MALAT1_rep3
